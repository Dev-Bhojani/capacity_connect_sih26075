...
export default function AdminLayout({
  ...
  if (!resolvedActivePage) {
    if (currentPath.includes("/users")) resolvedActivePage = "users";
      ...
      resolvedActivePage = "competencies";
    else if (currentPath.includes("/knowledge-hub"))
      resolvedActivePage = "knowledge-hub";
    else if (currentPath.includes("/approvals"))
      resolvedActivePage = "approvals";
  ...
  const titleMap = {
    dashboard: {
      ...
      crumbs: ["Capacity Connect", "Executive Dashboard"],
    },
    users: {
      title: "User Management Directory",
      crumbs: ["Capacity Connect", "Users", "All Users"],
    },
    trainers: {
      title: "Trainer Management & Roster",
      crumbs: ["Capacity Connect", "Faculty", "Trainers"],
    },
    learners: {
      title: "Learner Cohort Tracking",
      crumbs: ["Capacity Connect", "Learners", "Active Cohorts"],
    },
    courses: {
      title: "Curriculum & Course Repository",
      crumbs: ["Capacity Connect", "Curricula", "All Courses"],
    },
    training: {
      title: "Capacity Building Programs",
      crumbs: ["Capacity Connect", "Programs", "Active Schedules"],
    },
    competencies: {
      title: "Competency Framework (iGOT/FRAC)",
      crumbs: ["Capacity Connect", "Competency Mapping"],
    },
    "knowledge-hub": {
      title: "Knowledge Hub & Digital Repository",
      crumbs: ["Capacity Connect", "Repository", "Guidelines & SOPs"],
    },
    approvals: {
      title: "Workflow & Verification Approval Center",
      crumbs: ["Capacity Connect", "Governance", "Approvals Queue"],
    },
    analytics: {
      title: "Enterprise Capacity Analytics",
      crumbs: ["Capacity Connect", "Intelligence", "KPI Metrics"],
    },
    reports: {
      title: "Compliance & Audit Reports",
      crumbs: ["Capacity Connect", "Audit Logs", "Export Center"],
    },
    settings: {
      title: "System Configuration & Integrations",
      crumbs: ["Capacity Connect", "Settings", "Backend & Portal"],
    },
  };

  const resolvedTitle =
    pageTitle || titleMap[resolvedActivePage]?.title || "Executive Dashboard";
  const resolvedBreadcrumbs = breadcrumbs ||
    titleMap[resolvedActivePage]?.crumbs || ["Admin", "Dashboard"];
  ...
  return (
    <div className="admin-container">
      ...
      >
        ...
        <div className="sidebar-footer">
          ...
          <button
            ...
            title="Sign Out"
            onClick={() =>
              alert("Simulated Sign Out: Session cleared successfully.")
            }
          >
            <FiLogOut />
          </button>
      ...
      <div
        className={`admin-main-wrapper ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}
      >
        {/* TOP NAVBAR */}
            ...
            {showNotifications && (
              <div className="dropdown-menu-popover dropdown-notifications">
                ...
                >
                  ...
                  <div className="notif-content">
                    <div className="notif-title">
                      New Course submitted: "Incident Command System"
                    </div>
                    <div className="notif-time">
                      15 mins ago • Col. Sanjeev Kapoor
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="notif-content">
                    <div className="notif-title">
                      450 public officials registered from Finance Ministry
                    </div>
                    <div className="notif-time">
                      2 hours ago • Batch Onboarding
                    </div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div className="notif-content">
                    <div className="notif-title">
                      New SOP Guide ready for publication review
                    </div>
            ...
            {showMessages && (
              <div className="dropdown-menu-popover dropdown-notifications">
                ...
                <div
                  className="notif-item"
                  onClick={() => {
                    alert("Opening message from Trainer Ananya Deshmukh");
                    setShowMessages(false);
                  }}
                >
                  <div className="notif-icon">
                  ...
                  <div className="notif-content">
                    <div className="notif-title">
                      Ananya Deshmukh (IIT Bombay)
                    </div>
                    <div className="notif-time">
                      "Can we add 2 more lab sessions to the AI Governance
                      syllabus?"
                    </div>
                  </div>
                </div>
                <div
                  className="notif-item"
                  onClick={() => {
                    alert("Opening message from Secretary Office");
                    setShowMessages(false);
                  }}
                >
                  <div className="notif-icon">
                  ...
                  <div className="notif-content">
                    <div className="notif-title">
                      Nodal Officer Office (MeitY)
                    </div>
                    <div className="notif-time">
                      "Quarterly competency gap metrics report required by 4
                      PM."
                    </div>
                  </div>
                </div>
