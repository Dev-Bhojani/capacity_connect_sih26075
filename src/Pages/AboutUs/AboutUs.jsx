      ...
      <main className="about-main-card">
        ...
        <section className="pillars-section">
          ...
          <div className="pillars-grid">
            <div className="pillar-card">
              ...
              <p>
                Discover structured courses, engage with interactive modules,
                complete assessments, and build practical skills[cite: 11].
              </p>
            </div>
            ...
            <div className="pillar-card">
              ...
              <p>
                Map your current skill levels, identify competency gaps against
                targets, and access personalized learning paths[cite: 11].
              </p>
            </div>
            ...
            <div className="pillar-card">
              ...
              <p>
                Access an approved central repository of best practices,
                technical guides, video tutorials, and reference
                documentation[cite: 11].
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="workflow-section">
          <h2 className="section-title">
            How It Works: Continuous Growth Cycle
          </h2>
          <div className="steps-container">
            <div className="step-item">
              ...
              <p>
                Assess your current competency profile against target
                organizational benchmarks[cite: 11].
              </p>
            </div>
            ...
            <div className="step-item">
              ...
              <p>
                Receive rule-based course recommendations designed to close
                identified skill gaps[cite: 11].
              </p>
            </div>
            ...
            <div className="step-item">
              ...
              <p>
                Complete module quizzes, earn verifiable completion
                certificates, and level up[cite: 11].
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="roles-section">
          <h2 className="section-title">
            Designed for Every Organizational Role
          </h2>
          <div className="roles-grid">
            <div className="role-box">
              ...
              <p>
                Track skill gaps, enroll in targeted courses, consume materials,
                and download certificates[cite: 11].
              </p>
            </div>
            ...
            <div className="role-box">
              ...
              <p>
                Build course modules, design assessments, upload Knowledge Hub
                guides, and monitor learner progress[cite: 11].
              </p>
            </div>
            ...
            <div className="role-box">
              ...
              <p>
                Manage organizational skill catalogues, approve content, oversee
                users, and track analytics[cite: 11].
              </p>
            </div>
          </div>
        </section>
