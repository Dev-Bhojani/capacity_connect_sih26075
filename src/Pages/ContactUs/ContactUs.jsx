    ...
    <div className="contact-page">
      ...
      <section className="contact-hero">
        <div className="hero-search-bar">
          ...
          <input
            type="text"
            placeholder="Search FAQs, platform support, help topics..."
          />
      ...
      <main className="contact-main-card">
        <section className="overview-section">
          ...
          <p className="main-subheading">
            Have questions about competency mapping, trainer approvals, or
            platform access? Our support team is here to assist you[cite: 11].
          </p>
        </section>
          ...
          <div className="form-container">
            ...
            {submitted ? (
              <div className="success-message">
                ...
                <p>
                  Your message has been submitted. Our team will review your
          ...
          <div className="faq-container">
            ...
            <div className="faq-list">
              <div className="faq-item">
                <h4>
                  <FiHelpCircle /> How is my skill gap calculated?
                </h4>
                <p>
                  Skill gaps are automatically calculated by taking your target
                  competency level minus your current verified skill level[cite:
                  11].
                </p>
              </div>
              ...
              <div className="faq-item">
                <h4>
                  <FiHelpCircle /> How do I request Trainer access?
                </h4>
                <p>
                  You can request a Trainer account during registration or
                  submit a role update request through your Learner account
                  settings[cite: 11].
                </p>
              </div>
              ...
              <div className="faq-item">
                <h4>
                  <FiHelpCircle /> Who approves Knowledge Hub resources?
                </h4>
                <p>
                  Uploaded guides, PDFs, and video resources are reviewed and
                  approved by Platform Administrators before becoming publicly
                  visible[cite: 11].
                </p>
              </div>
              ...
              <div className="faq-item">
                <h4>
                  <FiHelpCircle /> Are completion certificates verifiable?
                </h4>
                <p>
                  Yes, all certificates earned upon passing course quizzes are
                  issued with unique system IDs for organizational
