...
const SkillGapDetails = ({
  ...
  const filteredSkills = useMemo(() => {
    ...
    return gapSkills.filter(
      (skill) => skill.priority.label === filterName,
    );
  ...
  const closestSkill = [...gapSkills].sort(
    (a, b) => a.gap - b.gap,
  )[0];
      ...
      <div className="skill-gap-details__table-section">
        ...
        <Card className="skill-gap-details__table-card">
          ...
          <div className="skill-gap-details__table-toolbar">
            ...
            <button
              type="button"
              className="skill-gap-details__sort"
            >
            ...
            <div className="skill-gap-details__table">
              ...
              {filteredSkills.length > 0 ? (
                filteredSkills.map((skill, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="skill-gap-details__gap">
                        {skill.gap}%
                      </div>
                ...
                <div className="skill-gap-details__empty">
                  ...
                  <span>
                    There are no skills matching this filter
                    right now.
                  </span>
        ...
        <Card className="skill-gap-details__focus-card">
          ...
          <div className="skill-gap-details__focus-header">
            ...
            <div>
              ...
              <p>
                Improving these skills can significantly enhance
          ...
          <div className="skill-gap-details__focus-list">
            ...
            <div className="skill-gap-details__focus-item">
              ...
              <div>
                ...
                <span>
                  In-demand skills open more doors.
                </span>
            ...
            <div className="skill-gap-details__focus-item">
              ...
              <div>
                ...
                <span>
                  Build stronger career potential.
                </span>
          ...
          <p className="skill-gap-details__focus-quote">
            “Skill development today creates the opportunities
            of tomorrow.”
          </p>
          ...
          <Button
            ...
            size="md"
            rightIcon={<FiArrowRight />}
            onClick={handleExploreLearningPaths}
        ...
        <Card className="skill-gap-details__analysis-card">
          ...
          <div className="skill-gap-details__analysis-header">
            ...
            <div>
              ...
              <p>
                Visualise the gap between your current and target
                skill levels.
              </p>
        ...
        <Card className="skill-gap-details__insights-card">
          ...
          <div className="skill-gap-details__analysis-header">
            ...
            <div>
              ...
              <p>
                A few things worth focusing on next.
              </p>
          ...
          <div className="skill-gap-details__insights-list">
            ...
            <div className="skill-gap-details__insight">
              ...
              <div>
                ...
                <span>
                  Only {closestSkill?.gap || 0}% gap remains
                </span>
            ...
            <div className="skill-gap-details__insight">
              ...
              <div>
                ...
                <span>
                  Keep building your weaker areas
                </span>
