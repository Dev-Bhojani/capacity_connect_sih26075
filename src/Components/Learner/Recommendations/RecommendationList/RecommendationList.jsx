...
const recommendationCourses = [
  {
    ...
    description:
      "Master modern JavaScript patterns and build scalable applications.",
...

  {
    ...
    description:
      "Work confidently with relational databases and complex queries.",
    category: "Data",
    level: 72,
    target: 85,
    duration: "6 weeks",
...

  {
    ...
    description:
      "Improve workplace communication, confidence, and presentation skills.",
  ...
  {
    id: "ocean-science-foundations",
    title: "Ocean Science Foundations",
    description: "Explore core concepts in ocean science and marine systems.",
    category: "Domain",
    level: 70,
    target: 82,
    duration: "6 weeks",
...

  {
    ...
    description:
      "Build maintainable React applications with scalable component patterns.",
    category: "Development",
    level: 68,
    target: 86,
    duration: "8 weeks",
...

  {
    ...
    description:
      "Learn practical Python techniques for analyzing and understanding data.",
    category: "Data",
    level: 58,
    target: 82,
    duration: "7 weeks",
...

  {
    ...
    description:
      "Develop decision-making, collaboration, and leadership capabilities.",
    category: "Soft Skills",
    level: 64,
    target: 88,
    duration: "5 weeks",
  ...
  {
    id: "marine-research",
    title: "Marine Research Essentials",
    description:
      "Understand research methods and essential practices used in marine studies.",
    category: "Domain",
    level: 61,
    target: 84,
    duration: "6 weeks",
...
const RecommendationList = ({ stats, onViewAllCourses, onExploreCourse }) => {
  ...
  const filteredCourses = useMemo(() => {
    if (activeCategory === "All") {
      return recommendationCourses;
    }

    return recommendationCourses.filter(
